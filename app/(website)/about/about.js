          ...
          <div className="mx-auto grid max-w-screen-xl px-4 py-8 lg:grid-cols-12 lg:gap-8 lg:py-16 xl:gap-0">
            <div className="mr-auto place-self-center lg:col-span-7">
              ...
              <p className="mb-6 max-w-2xl text-justify font-light text-gray-500 md:text-lg lg:mb-8 lg:text-xl dark:text-gray-400">
                ...
                morbi tristique senectus et. Sit amet mattis vulputate
                enim. Vitae et leo duis ut diam. Metus vulputate eu
                scelerisque felis imperdiet proin fermentum leo.
                Luctus venenatis lectus magna fringilla urna.
                Consectetur adipiscing elit pellentesque habitant
                morbi tristique senectus et. Ultrices dui sapien eget.
              </p>
            </div>
